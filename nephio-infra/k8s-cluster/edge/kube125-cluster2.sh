...
EOF
# Install CNI
kubectl apply -f https://raw.githubusercontent.com/Playground-For-DevOps/aws-cloudformation-templates/master/nephio-infra/k8s-cluster/cluster2/kube-flannel2.yml
